...
var angular=require("angular");angular.module("teacherHelper",[require("./helper-app")]);

},{"./helper-app":3,"angular":9}],2:[function(require,module,exports){
function DebounceSelectionDirective(e){return{restrict:"A",require:"?ngModel",link:function(n,i,c,t){function u(){r&&(e.cancel(r),r=null)}function l(){r||(r=e(o,2500))}function o(){i[0].select(),r=null}if(t){var r=null;t.$viewChangeListeners.push(function(){u(),l()}),i.on("blur",u)}}}}var angular=require("angular");module.exports=angular.module("teacherHelper.app.debounceSelection",[]).directive("debounceSelection",DebounceSelectionDirective).name,DebounceSelectionDirective.$inject=["$timeout"];

},{"angular":9}],3:[function(require,module,exports){
var angular=require("angular");module.exports=angular.module("teacherHelper.app",[require("./percentage-helper-controller"),require("./debounce-selection")]).name;

},{"./debounce-selection":2,"./percentage-helper-controller":4,"angular":9}],4:[function(require,module,exports){
function HelperAppController(){this.correct=10,this.outOf=10,this.calculate=percentage.calculate,this.column=percentage.column}var angular=require("angular");module.exports=angular.module("teacherHelper.app.percentage.ctrl",[]).controller("PercentageController",HelperAppController).name;var percentage=require("../percentage");

},{"../percentage":7,"angular":9}],5:[function(require,module,exports){
function calculatePercentage(e,t,a){var c=e/t*100;return"number"==typeof a&&(c=c.toFixed(a)),c}module.exports=calculatePercentage;

},{}],6:[function(require,module,exports){
function calculateColumn(e,a){var c,l=[];for(c=0;e>=c;c++)l.push(calculatePercentage(c,e,a));return l}module.exports=calculateColumn;var calculatePercentage=require("./calculate-percentage");

},{"./calculate-percentage":5}],7:[function(require,module,exports){
module.exports={calculate:require("./calculate-percentage"),column:require("./chart-column")};
...
//# sourceMappingURL=0.0.1.teacher-helper.min.js.map